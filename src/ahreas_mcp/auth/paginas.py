"""As telas HTML do login Ahreas no fluxo OAuth.

Mínimo proposital: um formulário de usuário e senha, sem framework de front,
porque isso abre uma vez por sessão dentro do navegador que o cliente MCP
controla. O texto é para a pessoa da administradora, não para quem programa.
"""
...
<title>Entrar no Ahreas</title><style>{_ESTILO}</style></head>
<body>
